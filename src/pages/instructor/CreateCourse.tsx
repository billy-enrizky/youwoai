...
import { ArrowLeft, ArrowRight, Check, Upload, FolderOpen, GripVertical, Sparkles } from "lucide-react";
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground">
                  Choose a folder from your notes or let AI generate a course structure.
                </p>
              </div>

              {/* AI Generate Option */}
              <Link to="/instructor/generate-proposal">
                <div className="rounded-xl border-2 border-primary/50 bg-primary/5 p-6 cursor-pointer hover:bg-primary/10 transition-all">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Upload PDFs and let AI create a course proposal for you
                      </p>
                    </div>
